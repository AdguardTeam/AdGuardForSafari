...
const EventNotifierTypes = module.exports = {
    ...
    SHOW_OPTIONS_GENERAL: "event.options.show.general",
    SHOW_OPTIONS_FILTERS: "event.options.show.filters",
    SHOW_OPTIONS_WHITELIST: "event.options.show.whitelist",
    SHOW_OPTIONS_USER_FILTER: "event.options.show.userfilter",
    // Log events
